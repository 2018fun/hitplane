...
var GuideController = (function () {
    ...
    GuideController.getInstance = function () {
        if (this.instance === null) {
            this.instance = new GuideController();
        }
        return this.instance;
    };
    GuideController.prototype.isNew = function () {
        console.log(this.guideData);
        return this.guideData === 0;
    };
    GuideController.prototype.isFinished = function () {
        console.log(this.guideList);
        return this.guideList.length >= 10;
    };
    GuideController.prototype.isPlaceGuideFinished = function () {
        return false;
    };
    GuideController.prototype.getGuideStep = function () {
        return this.current_step;
    };
    GuideController.prototype.getGuide = function () {
        return this.guideData;
    };
    GuideController.prototype.saveGuide = function (value) {
        this.guideData = value;
        SaveDataManager.getInstance().setGuide(this.guideData);
    };
    GuideController.prototype.dropPlaneGuide = function () {
        // SceneManager.getInstance().popLayer
    };
    GuideController.prototype.startAwayGuide = function () {
        this.current_step = 1;
        this.guideStep(this.current_step);
    };
    GuideController.prototype.hitGridGuide = function (gridId) {
        console.log("grid" + gridId);
        var awayScene = SceneManager.getInstance().awayScene;
    ...
    GuideController.prototype.guideStep = function (step) {
        var awayScene = SceneManager.getInstance().awayScene;
        awayScene.updateMsg();
        switch (step) {
    ...
    GuideController.prototype.onNextGuide = function (e) {
        if (e === void 0) { e = null; }
        this.current_step++;
    ...
    GuideController.prototype.guideFinished = function () {
