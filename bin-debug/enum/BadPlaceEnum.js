...
(function (BadPlaceEnum) {
    /**
      ...
      */
    BadPlaceEnum.BAD_GRID_LIST = [4, 13, 20, 20, 24, 24, 31, 36,
        37, 39, 40, 40, 40, 40, 41, 43,
        44, 49, 56, 56, 60, 60, 67, 76];
    /**
      *  可能会导致无法放置三架飞机的格子的飞机方向  //辅助头来确定方向，有的格子可能不用，但是为了数据对应都填上了
      */
    BadPlaceEnum.BAD_GRID_DIRECTION_LIST = [DirectionTypeEnum.UP, DirectionTypeEnum.UP,
    ...
    /**
      ...
      */
    BadPlaceEnum.BAD_GRID_TEST_LIST = [[10, 22], [23], [13, 14], [10, 17],
    ...
    /**
      *  肯定不会出现飞机头的格子    //打算放置礼包
      */
    BadPlaceEnum.GIFT_GRID_LIST = [0, 8, 72, 80];
})(BadPlaceEnum || (BadPlaceEnum = {}));
